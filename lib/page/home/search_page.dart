...
import 'package:eyepetizer_flutter/plugin/speech_plugin.dart';
import 'package:eyepetizer_flutter/utils/navigator_util.dart';
import 'package:eyepetizer_flutter/viewmodel/home/search_viewmodel.dart';
...
import 'package:eyepetizer_flutter/widget/search_item_widget.dart';
...
class SearchPage extends StatelessWidget {
      ...
      child: ConstrainedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            // 提示文本，位于输入框内部
            hintText: EyeString.interest_video,
            // hintText的样式
  ...
  Widget _searchVideoWidget(SearchViewModel model) {
    return Offstage(
      offstage: model.dataList == null || model.dataList.isEmpty,
