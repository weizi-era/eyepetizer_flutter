...
import 'package:eyepetizer_flutter/page/web_page.dart';
...
import 'package:eyepetizer_flutter/viewmodel/discovery/news_viewmodel.dart';
  ...
  List<Widget> _getTitleList(List<String> titleList) {
    return titleList.map((title) {
      return Padding(
        ...
        child: Text(title,
            style: TextStyle(color: EyeColor.desTextColor, fontSize: 12),
            // 做多显示三行
            maxLines: 3,
            // 超出的部分，省略号处理
