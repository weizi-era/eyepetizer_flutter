...
import 'package:eyepetizer_flutter/viewmodel/discovery/recommend_photo_viewmodel.dart';
...
class RecommendPhotoPage extends StatelessWidget {
  ...
  const RecommendPhotoPage({Key? key, required this.galleryItems}) : super(key: key);
  ...
  Widget _photoViewGallery(RecommendPhotoViewModel model) {
    return PhotoViewGallery.builder(
      builder: (BuildContext context, int index) => PhotoViewGalleryPageOptions(
        // 显示的图片
        imageProvider: cacheNetworkImageProvider(galleryItems[index]),
        // 初始缩放
