...
import 'package:eyepetizer_flutter/utils/format_duration_util.dart';
      ...
      onTap: () async {
        ...
        final chosenSpeed = await showModalBottomSheet<double>(
          ...
          builder: (context) => _PlaybackSpeedDialog(
            // 可以选择的播放速度
            allowedSpeeds: chewieController.playbackSpeeds,
            // 当前的播放速度
            currentSpeed: _latestValue!.playbackSpeed,
          ),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final speed = _allowedSpeeds[index];
        return ListTile(
