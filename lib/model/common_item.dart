...
class PlayInfo {
  String? name;
  int? width;
  List<DataPlayinfoUrllist>? urlList;
  String? type;
  String? url;
  int? height;
  ...
  PlayInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json['urlList'] != null) {
      ...
      (json['urlList'] as List).forEach((v) {
        urlList?.add(new DataPlayinfoUrllist.fromJson(v));
      });
    }
    type = json['type'];
    url = json['url'];
...
class Author {
  ...
  Author.fromJson(Map<String, dynamic> json) {
    shield = json['shield'] != null
        ? new DataAuthorShield.fromJson(json['shield'])
        : null;
    expert = json['expert'];
    ...
    follow = json['follow'] != null
        ? new DataAuthorFollow.fromJson(json['follow'])
        : null;
...
class DataPlayinfoUrllist {
  int? size;
  String? name;
  String? url;

  DataPlayinfoUrllist({this.size, this.name, this.url});

  DataPlayinfoUrllist.fromJson(
...
class DataAuthorShield {
  ...
  DataAuthorShield.fromJson(Map<String, dynamic> json) {
    itemId = json['itemId'];
...
class DataAuthorFollow {
  ...
  DataAuthorFollow.fromJson(Map<String, dynamic> json) {
    itemId = json['itemId'];
    itemType = json['itemType'];
